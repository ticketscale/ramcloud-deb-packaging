...
cd /data/RAMCloud/ && \
apt-get update && \
apt-get install -y software-properties-common python-software-properties build-essential liberror-perl git libpcre3 libncurses5-dev libssl-dev libpcre3-dev && \
